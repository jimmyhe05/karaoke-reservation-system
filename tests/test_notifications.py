...
def test_notification_creation_and_retrieval(client):
    ...
    user_id = mock_login_customer(client, "test_notif@example.com", "Notif User")
...
def test_email_preferences_check(mock_send_confirmation, client):
    ...
    user_id = mock_login_customer(client, "no_email@example.com", "No Email User")
...
def test_customer_bookings_and_cancel(client):
    user_id = mock_login_customer(client, "bookings@example.com", "Booking User")
