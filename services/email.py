...
def send_confirmation(res):
    ...
    body = (
        ...
        f"If you need to cancel your reservation, you can do so up to {cutoff_hours} "
        f"hours before the start time using this link:\n"
        f"{cancel_url}\n\n"
...
def send_rejection(res, reason):
    ...
    body = (
        ...
        f"If you'd like to try booking a different date, room, or time, please feel "
        f"free to submit a new request on our website.\n\n"
        f"Best,\nNam's Noodle & Karaoke Team"
    )
    _send_email(res["contact_email"], subject, body)
